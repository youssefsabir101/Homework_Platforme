      ...
      <nav aria-label="breadcrumb" className="fixed top-16 w-full p-4 backdrop-blur-sm bg-white bg-opacity-70 z-30">
        <div className="container mx-auto flex items-center space-x-2 text-sm text-blue-500">
          ...
          <span className="font-semibold flex items-center">
            <FaBook className="mr-1 text-blue-500" /><span className="font-semibold text-blue-500">Devoirs</span>
          </span>
        </div>
      </nav>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center text-sm text-gray-500 mb-4">
                    <span>{homework.teacher && (
                            <p className="text-gray-500 mb-4">Créé par : {homework.teacher.name}</p>
                          )}
                    </span>
